defmodule OnesignalElixir.BuilderTest do
  ...
  test "exclude a segment" do
    ...
    assert Enum.all?(
             notification.excluded_segments,
             &(&1 in ["Active Users"])
           )
  end
  ...
  test "adding content to notification" do
    ...
    assert notification.contents == %{
             :en => "Welcome to One Signal",
             :es => "Bienvenido a One Signal"
           }
  end
  ...
  test "adding big picture to notification" do
    ...
    assert notification.big_picture ==
             "https://xcelerator.ninja/static/media/main-logo.ff98436a.png"
  end
