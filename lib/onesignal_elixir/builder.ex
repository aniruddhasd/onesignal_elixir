defmodule OnesignalElixir.Builder do
  ...
  def buttons(notification, buttons_data) do
    buttons =
      Enum.map_reduce(buttons_data, 0, fn button_data, acc ->
        {%{
           id: "id" <> Integer.to_string(acc),
           text: elem(button_data, 0),
           icon: elem(button_data, 1)
         }, acc + 1}
      end)
      |> elem(0)
  ...
  def add_android_channel_id(notification, channel_id) do
    Map.put(notification, :android_channel_id, channel_id)
  end
end
